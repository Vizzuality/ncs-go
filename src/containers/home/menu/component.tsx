...
import MenuButton from 'containers/home/menu/menu-button';
  ...
  return (
    <div className="relative">
      {minWidth < BREAKPOINTS.lg && (
        <>
          <section className="relative z-10 w-full h-24 font-sans text-center text-white bg-gray-900 border border-orange-400">
            <Wrapper>
              ...
              <Wrapper>
                ...
                <div className="">
                  <p className="text-sm leading-5 text-white">
                    Subscribe to keep up to date on our progress and be among the first to access
                    our platform.
                  </p>
                </div>
              </Wrapper>
