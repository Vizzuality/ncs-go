export const COMMON_CONTENT_CLASSES =
  'absolute pointer-events-auto top-1/2 inset-x-4 left-0 sm:left-1/2 transform -translate-y-1/2 w-full h-full sm:h-auto sm:max-h-[90%] sm:-translate-x-1/2 outline-none bg-white flex flex-col grow overflow-hidden sm:-rounded-xl';
